...
def upgrade() -> None:
    ...
    sa.Column('id', sa.Uuid(), nullable=False),
    sa.Column('user_id', sa.Uuid(), nullable=False),
    sa.Column('pluggy_connection_id', sqlmodel.sql.sqltypes.AutoString(), nullable=False),
    sa.Column('institution_image_url', sqlmodel.sql.sqltypes.AutoString(), nullable=False),
    sa.Column('institution_name', sqlmodel.sql.sqltypes.AutoString(), nullable=False),
    sa.Column('status', sa.Enum('UPDATED', 'LOGIN_ERROR', 'UPDATING', 'OUTDATED', name='connectionstatus'), nullable=False),
